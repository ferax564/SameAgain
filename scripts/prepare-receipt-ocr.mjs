...
await copyFile('node_modules/tesseract.js/dist/worker.min.js.LICENSE.txt',dest+'/worker.LICENSE.txt');
...
for(const f of await readdir('node_modules/tesseract.js-core'))if(f.endsWith('.wasm.js'))await copyFile('node_modules/tesseract.js-core/'+f,dest+'/core/'+f);
